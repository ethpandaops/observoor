-- Migration 004: add CPU utilization summary table.

CREATE TABLE cpu_utilization_local ON CLUSTER '{cluster}' (
...
CREATE TABLE cpu_utilization ON CLUSTER '{cluster}' AS cpu_utilization_local
ENGINE = Distributed(
    '{cluster}',
    currentDatabase(),
