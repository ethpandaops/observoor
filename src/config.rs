...
mod tests {
    ...
    fn test_sampling_default_profile_rules() {
        ...
        assert_eq!(futex.nth, 40);
        assert!((futex.rate - 0.025).abs() < 0.0001);
        ...
        assert_eq!(net_tx.nth, 40);
        assert!((net_tx.rate - 0.025).abs() < 0.0001);
        ...
        assert_eq!(disk.nth, 40);
        assert!((disk.rate - 0.025).abs() < 0.0001);
    }
